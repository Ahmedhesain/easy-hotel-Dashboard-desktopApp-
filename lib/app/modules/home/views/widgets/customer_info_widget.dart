                  ...
                  Row(
                    children: [
                      ...
                      Container(
                          ...
                          child: TextFormField(
                            controller: TextEditingController(text: controller.selectedCustomer.value?.taxNumber?.toString()),
                            decoration: const InputDecoration(border: InputBorder.none, isDense: true),
                            textAlign: TextAlign.center,
                            onChanged: (value) => controller.selectedCustomer.value?.taxNumber = value,
                          )
                      ),
                      const SizedBox(width: 10),
                      const Text(
                      ...
                      Container(
                          ...
                          width: size.width * 0.12,
                          child: TextFormField(
                            controller: TextEditingController(text: controller.selectedCustomer.value?.citySubdivisionName?.toString()),
                            decoration: const InputDecoration(border: InputBorder.none, isDense: true),
                            textAlign: TextAlign.center,
                            onChanged: (value) => controller.selectedCustomer.value?.citySubdivisionName = value,
                          )
                      ),
                    ],
                  )
