...
class BranchWidget extends GetView<RestrauntHomeController> {
                          ...
                          children: [
                            Padding(
                              ...
                              child: LinearPercentIndicator(
                                width: size.width *.13,
                                trailing: TextWidget(valueOne.toString(),size: 10,textColor: Colors.white,),
                                animation: true,
                                lineHeight: 9.0,
                            ...
                            Padding(
                              ...
                              child:  LinearPercentIndicator(
                                width: size.width *.13,
                                animation: true,
                                trailing: TextWidget(valueTwo.toString(),size: 10,textColor: Colors.white,),
                                lineHeight: 9.0,
                                animationDuration: 2500,
                                percent: 0.65,
                                // center: TextWidget("80.0%",size: 6,),
                      ...
                      Column(
                        children: [
                          Padding(
                            ...
                            child:  LinearPercentIndicator(
                              width: size.width *.13,
                              trailing: TextWidget(valueThree.toString(),size: 10,textColor: Colors.white,),
                              animation: true,
                              lineHeight: 9.0,
                              animationDuration: 2500,
                              percent:valueThree!/10,
                              // center: TextWidget("80.0%",size: 6,),
                              linearStrokeCap: LinearStrokeCap.roundAll,
                              progressColor: AppColors.yellow,
                            ),
                          ...
                          Padding(
                            ...
                            child:  LinearPercentIndicator(
                              width: size.width *.13,
                              animation: true,
                              trailing: TextWidget(valueFour.toString(),size: 10,textColor: Colors.white,),
                              lineHeight: 9.0,
                              animationDuration: 2500,
                              percent: 0.65,
                              // center: TextWidget("80.0%",size: 6,),
