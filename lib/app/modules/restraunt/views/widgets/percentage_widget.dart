...
class PercentageWidget extends GetView<RestrauntHomeController> {
  const PercentageWidget(this.name, this.value,  {Key? key}) : super(key: key);
  final String? name;
  final double? value;
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: TextWidget(name!,size: 20,textColor: AppColors.font,weight: FontWeight.bold,),
          ),
          Padding(
            padding: EdgeInsets.fromLTRB(5.0,0,20,5),
            child: new LinearPercentIndicator(
              width: size.width *.3,
              trailing: TextWidget(value.toString(),size: 25,textColor: AppColors.font,),
              animation: true,
              lineHeight: 11.0,
