...
import 'package:hotel_manger/app/data/model/halls/dto/response/order_response.dart';
import 'package:hotel_manger/app/data/model/halls/dto/response/review_response.dart';
import 'package:hotel_manger/app/data/repository/application/halls_repository.dart';
...
class HallsHomeController extends GetxController {
  ...
  void onInit() {
    ...
    getClientMasseges();
    getClientComments();
    final wsUrl = Uri.parse('ws://localhost:8005/ws/holeDashboard?filterId=232');
    ...
    final wsUrlReview = Uri.parse('ws://localhost:8005/ws/reviewHoleDashboard?filterId=232');
  ...
  getNumOrders() async {
    ...
    HallsAppRepository().getNumOrders(request,
        onSuccess: (data) {
  ...
  getNumberOrdersUnderProcessing() async {
    ...
    HallsAppRepository().getNumberOrdersUnderProcessing(request,
        onSuccess: (data) {
  ...
  getNumberOrdersDelivered() async {
    ...
    HallsAppRepository().getNumberOrdersDelivered(request,
        onSuccess: (data) {
  ...
  //
  //   );
  //   HallsAppRepository().getNumberOrdersLate( request,
  //       onSuccess: (data) {
  ...
  getTotalValueOrders() async {
    ...
    HallsAppRepository().getTotalValueOrders(request,
        onSuccess: (data) {
  ...
  getSalesOfTheWeek() async {
    ...
    HallsAppRepository().getSalesOfTheWeek(request,
        onSuccess: (data) {
  ...
  getBestSelling(){
    ...
    final request = AppRequest(
        branchId: 232,);
    HallsAppRepository().getBestSelling(
      request,
  ...
  getMostBuingClients(){
    ...
    final request = AppRequest(
        branchId: 232,);
    HallsAppRepository().getMostBuyingClients(
      request,
      onSuccess: (data)async{
  ...
  getGroupValueForDayAndMonth(){
    ...
    final request = AppRequest(
        branchId: 232,);
    HallsAppRepository().getGroupValueForDayAndMonth(
      request,
      onSuccess: (data)async{
  ...
  getClientMasseges(){
    ...
    final request = AppRequest(
        branchId: 232,);
    HallsAppRepository().getClientMasseges(
      request,
      onSuccess: (data)async{
  ...
  getClientComments(){
    ...
    final request = AppRequest(
        branchId: 232,);
    HallsAppRepository().getClientComments(
      request,
      onSuccess: (data)async{
