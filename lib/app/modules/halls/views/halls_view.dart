...
import 'package:hotel_manger/app/modules/halls/controllers/halls_controller.dart';
import 'package:hotel_manger/app/modules/halls/views/widgets/branch.dart';
import 'package:hotel_manger/app/modules/halls/views/widgets/buy_menu_widget.dart';
import 'package:hotel_manger/app/modules/halls/views/widgets/left_tap.dart';
import 'package:hotel_manger/app/modules/halls/views/widgets/percentage_widget.dart';
import 'package:hotel_manger/app/modules/halls/views/widgets/top_bar_widget.dart';
import 'package:hotel_manger/app/modules/halls/views/widgets/user_card.dart';


import 'widgets/complain_card.dart';


class HallsHomeView extends GetView<HallsHomeController> {
  const HallsHomeView
                          ...
                          child: Column(
                            children: [
                              Row(
                                ...
                                children: [
                                  Obx(() {
                                    return TopBarWidget(" الاوردرات الي طلبت في اليوم ",
                                        controller.numOrders.value.toDouble());
                                  }),
                                  TopBarWidget("  الاوردرات الي تم حجزها",
                                      controller.numberOrdersUnderProcessing
                                          .value.toDouble()),

                                  TopBarWidget(" الاوردرات الي  محجوزة اليوم ",
