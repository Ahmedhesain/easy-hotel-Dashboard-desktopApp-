...
class InvoicesWithoutSwingView extends GetView<InvoicesWithoutSwingController> {
  const InvoicesWithoutSwingView({super.key});
                                          ...
                                          GestureDetector(
                                              ...
                                              child:Row(children: [
                                                ...
                                                GestureDetector(onTap: (){
                                                  controller.getInvoicesWithoutSwing();
                                                },
                              ...
                              child:SingleChildScrollView(physics:  const AlwaysScrollableScrollPhysics(),
                                child: Column(children: [
                                  Container(
                                    ...
                                    child: Table(
                                      defaultColumnWidth: FixedColumnWidth(size.width * .198),
                                      ...
                                      children: [
                                        ...
                                        TableRow(children: [
                                          Column(children: [Text('رقم الفاتوره',
                                        ...
                                        if(controller.reports != null)
                                          ...
                                          for(CompanyInvoicesWithoutSewingResponse kha in controller.reports??[] )
                                            TableRow(children: [
                                              Column(children: [
                                                Text(
                                                    kha.id!.toString(),
