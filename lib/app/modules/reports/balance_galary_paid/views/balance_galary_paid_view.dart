...
import 'package:toby_bills/app/modules/reports/balance_galary_paid/controllers/balance_galary_paid_controller.dart';


class BalanceGallarypaidView extends GetView<BalanceGallarypaidController> {
  const BalanceGallarypaidView({super.key});
                                          ...
                                          GestureDetector(
                                              ...
                                              child:Row(children: [
                                                ...
                                                UnconstrainedBox(
                                                  child: Obx(() {
                                                    return ElevatedButton(
                                                      onPressed: controller.reports.isEmpty ? null : () => ExcelHelper.BalanceGallarypaidExcel(controller.reports, context),
                                    ...
                                    child: Table(
                                      ...
                                      children: [
                                        ...
                                        if(controller.reports != null)
                                          ...
                                          for(BalanceGalaryUnpaidResponse kha in controller.reports??[] )
                                            TableRow(children: [
                                              Column(children: [
                                                Text(
                                                    kha.gallaryName??"",
