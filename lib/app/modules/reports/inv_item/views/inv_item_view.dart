                ...
                child: Center(
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: const BorderRadius.all(Radius.circular(10)), color: Colors.white, border: Border.all(color: Colors.grey)),
                      child: Column(
                        children: [
                          Padding(
                                                    ...
                                                    child: Obx(() {
                                                      return ElevatedButton(
                                                        onPressed: controller.reports.isEmpty
                                                            ? null
                                                            : () => PrintingHelper().printInvItem(context, controller.reports),
                                                  ...
                                                  UnconstrainedBox(
                                                    child: Obx(() {
                                                      return ElevatedButton(
                                                        onPressed: controller.reports.isEmpty
                                                            ? null
                                                            : () => ExcelHelper.InvtemExcel(controller.reports, context),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Container(width: size.width * .03, height: size.height * .03, child: const SizedBox()),
                            ),
                          ),
                          Container(
                              width: size.width,
                                    ...
                                    Container(
                                      ...
                                      child: Table(
                                        ...
                                        children: [
                                          TableRow(
                                            children: [
                                              Column(children: [const Text('رقم الصنف', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('اسم الصنف', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('التكلفه', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('اعلي سعر للرجال', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('اعلي سعر للشباب', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('اقل سعر للرجال', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('اقل سعر للشباب', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('عدد الامتار المجانيه للرجال', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('عدد الامتار المجانيه للشباب', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [const Text('عدد الامتار للرجال', style: TextStyle(fontSize: 20.0))]),
                                              Column(children: [
                                                Center(
                                                  child: const Text('عدد الامتار للشباب', style: TextStyle(fontSize: 20.0)),
                                                )
                                              ]),
                                              Column(children: [
                                                Center(
                                                  child: const Text('طبيعه الصنف', style: TextStyle(fontSize: 20.0)),
                                                )
                                              ]),
                                              Column(children: [
                                                Center(
                                                  child: const Text('المتاح', style: TextStyle(fontSize: 20.0)),
                                                )
                                              ]),
                                            ],
                                          ...
                                          if (controller.reports != null)
                                            for (InvItemDtoResponse kha in controller.reports ?? [])
                                              TableRow(
                                                children: [
                                                  Column(children: [Text(kha.code!, style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.name!, style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.sellPrice!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.maxpricemen!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.maxpriceyoung!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.minpricemen!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.minpriceyoung!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(
                                                      children: [Text(kha.numbermetersfreemen!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [
                                                    Text(kha.numbermetersfreeyoung!.toString(), style: const TextStyle(fontSize: 20.0))
                                                  ]),
                                                  Column(children: [Text(kha.numbermetersmen!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.numbermetersyoung!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.itemNatural!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                  Column(children: [Text(kha.quantity!.toString(), style: const TextStyle(fontSize: 20.0))]),
                                                ],
                                                decoration: const BoxDecoration(
                                                    color: appGreyLight,
                                                    borderRadius: BorderRadius.only(topRight: Radius.circular(0), topLeft: Radius.circular(0))),
