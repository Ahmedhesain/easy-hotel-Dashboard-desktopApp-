                                    ...
                                    child: Table(
                                      ...
                                      children: [
                                        ...
                                        TableRow(children: [
                                          ...
                                          Column(children: [const Text('اسم العميل',
                                              style: TextStyle(fontSize: 20.0))
                                          ]),
                                          Column(children: [const Text('تاريخ آخر فاتوره',
                                              style: TextStyle(fontSize: 20.0))
                                          ]),
                                          Column(children: [const Text('الهاتف',
                                              style: TextStyle(fontSize: 20.0))
                                          ]),
                                          Column(children: [const Text('اجمالي التعامل',
                                              style: TextStyle(fontSize: 20.0))
                                          ]),
