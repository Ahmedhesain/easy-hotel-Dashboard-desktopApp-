...
class ItemsBalancesStatementController extends GetxController{

  final List<ItemsBalanceResponse> _allReports = [];
  final reports = <ItemsBalanceResponse>[].obs;
  ...
  getItemsBalances() async {
    ...
    ReportsRepository().ItemsBalances(request,
        onSuccess: (data) {
