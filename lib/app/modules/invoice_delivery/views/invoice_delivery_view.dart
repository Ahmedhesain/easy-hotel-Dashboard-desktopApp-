...
import 'package:toby_bills/app/modules/invoice_delivery/controllers/invoice_delivery_controller.dart';

class InvoiceDeliveryView extends GetView<InvoiceDeliveryController> {
  const InvoiceDeliveryView({Key? key}) : super(key: key);
  @override
                ...
                Stack(
                  ...
                  children: [
                              ...
                              Expanded(
                                child: FractionallySizedBox(
                                  ...
                                  child: Text(controller.invoiceModel.value == null
                                      ? ""
                                      : "${controller.invoiceModel.value!.customerBalance}"),
                                ),
                              ),
                              const SizedBox(width: 20),
                              const Expanded(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: FractionallySizedBox(
                                  ...
                                  child: Text(controller.invoiceModel.value == null
                                      ? ""
                                      : "${controller.invoiceModel.value!.numberOfToob}"),
                                ),
                              ),
                              const SizedBox(width: 20),
                              const Expanded(
                    ...
                    const Positioned(
                      top: -10,
                      right: 65,
                      child: Text("تسليم الفاتورة بالمعرض"),
                    ),
                  ],
                ),
                const SizedBox(height: 40),
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      const Positioned(
                        top: -10,
                        right: 65,
                        child: Text("بيانات نسليم الفاتورة بالمعرض"),
                      ),
                    ],
                  ),
                )
