...
class _DateFormatFieldState extends State<DateFormatField> {
  late final TextEditingController _dobFormater = TextEditingController();
  ...
  void didChangeDependencies() async {
    ...
    if(widget.initialDate != null){
      ...
      // final value = widget.initialDate!.toIso8601String().split('T').first.replaceAll("-", "/").split("/").reversed.join("/");
      // _dobFormater.text = value;
      // formatInput(value);
    }
  }
  ...
  Future<void> fromDate(DateTime picked) async {
      String inputText;
      switch (widget.type) {
        case DateFormatType.type1:
          inputText = '${picked.day}/${picked.month}/${picked.year % 100}';
