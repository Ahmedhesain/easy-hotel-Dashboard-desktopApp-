...
class PrintingHelper {
  void printCatchReceipt(GlBankTransactionApi glBankTransactionApi, m.BuildContext context, String? customerName, String? galleryName) async {
    ...
    final boldStyle = TextStyle(font: ttfBold, fontSize: 7.5, fontBold: ttfBold);
            ...
            Directionality(
              ...
              child: Column(children: [
                ...
                Table(border: TableBorder.all(width: 1), children: [
                  ...
                  //table content
                  for (GlPayDTO detail in glBankTransactionApi.glPayDTOAPIList!)
                    TableRow(children: [
                      Container(
                          width: 30,
                          child: Center(
  ...
  void printSubAccountStatements(m.BuildContext context,
      {required List<AccountSummaryResponse> statements,
      DateTime? fromDate,
      DateTime? toDate,
      required String fromCenter,
      required String toCenter}) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
            ...
            Table(border: TableBorder.all(width: 1), columnWidths: widths, children: [
              TableRow(children: [
                Container(
                    ...
                    child: Center(
                        child:
                            Text("الرصيد", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    child: Center(
                        child: Text("دائن", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    child: Center(
                        child: Text("مدين", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    child: Center(
  ...
  void printGeneralJournal(GeneralJournalModel generalJournalModel, m.BuildContext context) async {
    ...
    for (GenralJournalDetailModel detail in generalJournalModel.detailDtoList!) {
      detail.creditAmount != null ? allCreditAmount += detail.creditAmount! : null;
    ...
    doc.addPage(MultiPage(
        footer: (context) => Container(
            height: 25,
            width: 650,
            decoration: const BoxDecoration(border: Border(top: BorderSide(color: PdfColors.black, width: 2))),
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Text('بيان قيود اليومية', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center),
                      ),
                    ),
                    SizedBox(height: 20),
                    Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                      HeadWidget(
                          value: generalJournalModel.generalData?.toIso8601String().split("T")[0],
                          title: 'تاريخ السند',
                          textStyle: boldStyle,
                          color: grey),
                      SizedBox(width: 40),
                      HeadWidget(value: generalJournalModel.generalTypeName, title: "نوع السند", textStyle: boldStyle, color: grey),
                      SizedBox(width: 60),
                      HeadWidget(value: generalJournalModel.generalDecument, title: "رقم السند ", textStyle: boldStyle, color: grey),
                      SizedBox(width: 60),
                      HeadWidget(value: generalJournalModel.serial, title: 'رقم القيد', textStyle: boldStyle, color: grey),
                    ]),
                    SizedBox(height: 20),
                    Row(children: [
                      Container(
                                ...
                                TableRow(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 25,
                                        child: Column(children: [
                                          Text(generalJournalModel.generalStatement ?? "", style: boldStyle, textDirection: TextDirection.rtl)
                                        ]),
                                      ),
                                      Container(
                                          color: grey,
                                          ...
                                          child: Center(
                                              child: Text('عنوان القيد',
                                                  style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                                    ]),
                              ]))
                    ]),
                    SizedBox(height: 20),
                            ...
                            children: [
                              TableRow(
                                  ...
                                  children: [
                                    Container(
                                        width: 100,
                                        child: Text('البيان', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                    // Container(
                                    //     width: 40,
                                    ...
                                    Container(
                                        width: 70,
                                        child: Text('مركز التكلفة', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                    Container(
                                        width: 70,
                                        child: Text('اسم الحساب', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                    Container(
                                        width: 40,
                                        child: Text('رقم الحساب', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                    Container(
                                        width: 30,
                                        child: Text('دائن', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                    Container(
                                        width: 30,
                                        child: Text('مدين', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                  ]),
                            ])),
                    for (GenralJournalDetailModel detail in generalJournalModel.detailDtoList!)
                      Container(
                              ...
                              children: [
                                TableRow(children: [
                                  Container(
                                      width: 100,
                                      child:
                                          Text(detail.discribtion!, style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                  // Container(
                                  //     width: 40,
                                  //     child: Text("",
                                  //         style: normalStyle,
                                  ...
                                  Container(
                                      width: 30,
                                      child: Text(detail.creditAmount != null ? detail.creditAmount!.toString() : "",
                                          style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                  Container(
                                      width: 30,
                                      child: Text(detail.debitAmount != null ? detail.debitAmount!.toString() : "",
                                          style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                ]),
                              ])),
                    Container(
                        ...
                        child: Table(
                            ...
                            children: [
                              TableRow(children: [
                                Container(
                                    width: 30, child: Text('مرحل', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                Container(
                                    width: 30, child: Text('موزون', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                Container(
                                    width: 30,
                                    color: grey,
                                    child: Text('قيد', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                Container(
                                    child: Text(DateFormat("dd-MM-yyyy").format(generalJournalModel.createdDate ?? DateTime.now()),
                                        style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                Container(
                                    width: 65,
                                    child: Text(generalJournalModel.createdByName ?? "",
                                        style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center)),
                                Container(
                                    width: 75,
                                    color: grey,
                    ...
                    Padding(
                        ...
                        child: Row(children: [
                          Column(children: [
                            Text('اعتماد', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center),
                            Text('.........', style: const TextStyle(color: grey)),
                          ]),
                          SizedBox(width: 150),
                          Column(children: [
                            Text('مدير الحسابات', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center),
                            Text('.........', style: const TextStyle(color: grey)),
                          ]),
                          SizedBox(width: 150),
                          Column(children: [
                            Text('المحاسب', style: boldStyle, textDirection: TextDirection.rtl, textAlign: TextAlign.center),
                            Text('.........', style: const TextStyle(color: grey)),
                          ]),
                        ]))
                  ],
            ...
            Table(border: TableBorder.all(width: 1), columnWidths: widths, children: [
              TableRow(children: [
                Container(
                    ...
                    child: Center(
                        child:
                            Text("المبلغ", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 60,
                    child: Center(
                        child:
                            Text("البيان", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 40,
                    child: Center(
                ...
                Container(
                    ...
                    width: 40,
                    child: Center(
                        child: Text("م", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
              ]),
              //table content
  ...
  void printPurchaseInvoice(m.BuildContext context, InvoiceModel invoiceModel,
      {num? value, num? dariba, num? total, num? discount, num? net, num? payed, num? remain}) async {
  ...
  void printInvoice(m.BuildContext context, InvoiceModel invoiceModel,
      {num? value, num? dariba, num? total, num? discount, num? net, num? payed, num? remain}) async {
    // LoginData? user = context.read<AuthProvider>().user ;
    Size size = m.MediaQuery.of(context).size;
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
    ...
    final ttfLight = Font.ttf(fontLight);
    final normalStyle = TextStyle(font: ttfLight, fontSize: 9);
    final boldStyle = TextStyle(font: ttfBold, fontSize: 9, fontBold: ttfBold);
    final boldStyle2 = TextStyle(font: ttfBold, fontSize: 9, fontBold: ttfBold);
    // final dm = Barcode.dataMatrix();
    //
    // final svg = dm.toSvg('114625', width: 80, height: 25);
            ...
            Center(
              child: SizedBox(
                child: Padding(
                  padding: const EdgeInsets.all(2),
                  child: Text(
                    invoiceModel.segilName.toString(),
                    style: boldStyle,
                    textDirection: TextDirection.rtl,
                  ),
                ),
            ...
            SizedBox(
              ...
              SizedBox(
                  ...
                  child: Column(children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text(
                        invoiceModel.gallaryPhone?.toString() ?? "........",
                        style: boldStyle,
                        textDirection: TextDirection.rtl,
                      ),
                      Spacer(),
              ...
              for (int i = 0; i < invoiceModel.invoiceDetailApiList!.length; i++)
                TableRow(
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        (invoiceModel.invoiceDetailApiList![i].net! + (invoiceModel.invoiceDetailApiList![i].net! * 0.15) ?? 0).toStringAsFixed(2),
                        style: boldStyle,
                        textAlign: TextAlign.center,
                        textDirection: TextDirection.rtl,
                      ))),
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        (invoiceModel.invoiceDetailApiList![i].net! * 0.15 ?? 0).toStringAsFixed(2),
                        style: boldStyle,
                        textAlign: TextAlign.center,
                        textDirection: TextDirection.rtl,
                      ))),                  Container(
            ...
            Table(border: TableBorder.all(width: 1), tableWidth: TableWidth.max, children: [
              TableRow(children: [
                Container(
                    ...
                    width: 45,
                    child: Center(
                        child: Text("#", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 45,
                    child: Center(
            ...
            Table(border: TableBorder.all(width: 1), tableWidth: TableWidth.max, children: [
              TableRow(children: [
                ...
                Container(
                    ...
                    child: Center(
                        child:
                            Text("الخزينة", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 40,
                    child: Center(
            ...
            Table(border: TableBorder.all(width: 1), tableWidth: TableWidth.max, children: [
              TableRow(children: [
                Container(
                    ...
                    child: Center(
                        child:
                            Text("الموظف", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 45,
                    child: Center(
                        child:
                            Text("المرحلة", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 55,
                    child: Center(
                        child:
                            Text("الكمية", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 60,
                    child: Center(
  ...
  void galleryInvoices(m.BuildContext context, List<InvoiceModel> data) async {
    ...
    final boldStyle = TextStyle(font: ttfBold, fontSize: 11, fontBold: ttfBold);
    doc.addPage(MultiPage(
        pageTheme: const PageTheme(pageFormat: PdfPageFormat.a4, orientation: PageOrientation.landscape, margin: EdgeInsets.all(10)),
        build: (Context context) {
          return [
            SizedBox(height: 50.5),
            Table(border: TableBorder.all(width: 1), tableWidth: TableWidth.max, children: [
              TableRow(children: [
                Container(
                    ...
                    child: Center(
                        child:
                            Text("check", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 40,
                    child: Center(
                        child:
                            Text("ملاحظات", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 40,
                    child: Center(
                ...
                Container(
                    ...
                    child: Center(
                        child:
                            Text("شركات", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 40,
                    child: Center(
                        child:
                            Text("المتبقي", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 40,
                    child: Center(
                ...
                Container(
                    ...
                    child: Center(
                        child:
                            Text("الحالة", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 40,
                    child: Center(
                        child:
                            Text("الهاتف", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 40,
                    child: Center(
                        child:
                            Text("العميل", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 60,
                    child: Center(
                        child: Text("كود", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 55,
                    child: Center(
            ...
            Table(border: TableBorder.all(width: 1), tableWidth: TableWidth.max, children: [
              TableRow(children: [
                Container(
                    ...
                    child: Center(
                        child:
                            Text("العدد", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                Container(
                    color: grey,
                    width: 45,
                    child: Center(
                        child:
                            Text("البند", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
              ]),
              //table content
              for (int i = 0; i < data.length; i++)
                TableRow(children: [
  ...
  void printItemBarcode(m.BuildContext context, ItemResponse item) async {
    ...
    final boldStyle2 = TextStyle(font: ttfBold, fontSize: 9, fontBold: ttfBold);
    doc.addPage(Page(
        pageTheme: const PageTheme(pageFormat: PdfPageFormat(96, 70), orientation: PageOrientation.landscape, textDirection: TextDirection.rtl),
        build: (Context context) {
          return Center(
              child: Column(
            children: [
  ...
  void printSalesItemsByCompany(
      m.BuildContext context, List<SalesOfItemsByCompanyResponse> data, DateTime datefrom, DateTime dateto, List<GalleryResponse> deliverysel) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
  ...
  void printProfitSold(m.BuildContext context, List<ProfitOfItemsSoldResponse> data, DateTime datefrom, DateTime dateto,
      List<GalleryResponse> deliverysel, String stat) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
              ...
              TableRow(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child:
                              Text("الاسم", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                  Container(
                      color: grey,
                      child: Center(
                          child:
                              Text("الكود", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                ],
              ),
              //table content
              for (int i = 0; i < data.length; i++)
  ...
  void printItemsBalance(m.BuildContext context, List<ItemsBalanceResponse> data, DateTime datefrom, DateTime dateto) async {
    ...
    doc.addPage(MultiPage(
        pageTheme: const PageTheme(
            pageFormat: PdfPageFormat.a4, textDirection: TextDirection.rtl, orientation: PageOrientation.portrait, margin: EdgeInsets.all(10)),
        maxPages: 1000,
        build: (Context context) {
          return [
            Column(
  ...
  void printCustomersNoMovement(
      m.BuildContext context, List<ClientsNoMovementResponse> data, List<DeliveryPlaceResposne> deliverysel, DateTime datefrom) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
  ...
  void printStatementOfBondsByBranch(
      m.BuildContext context, List<FindStatementOfBondsByBranchReportResponse> data, DateTime datefrom, DateTime dateto) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
              ...
              TableRow(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child:
                              Text("النوع", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                  Container(
                      color: grey,
                      child: Center(
                          child:
  ...
  void printSalesValueAddedDetails(m.BuildContext context, List<FindSalesValueAddedDetailsResponse> data, DateTime datefrom, DateTime dateto,
      List<DeliveryPlaceResposne> deliverysel) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
  ...
  void printSalesValueAdded(m.BuildContext context, List<FindSalesValueAddedResponse> data, DateTime datefrom, DateTime dateto,
      List<DeliveryPlaceResposne> deliverysel) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    ...
    doc.addPage(MultiPage(
        ...
        build: (Context context) {
          return [
            ...
            Directionality(
              textDirection: TextDirection.rtl,
              child: Table(border: TableBorder.all(width: 1), columnWidths: widths, tableWidth: TableWidth.max, children: [
                TableRow(
                  decoration: BoxDecoration(color: grey),
                  children: [
                    Container(
  ...
  void printBalanceGallary(
      m.BuildContext context, List<BalanceGalaryResponse> data, DateTime datefrom, DateTime dateto, List<DeliveryPlaceResposne> deliverysel) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
  ...
  void printInvoiceMovement(m.BuildContext context, List<InvoiceMovementResponse> data, DateTime datefrom, DateTime dateto, int frominvoice,
      int toinvoice, List<GalleryResponse> deliverysel) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
              ...
              TableRow(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child:
                              Text("رقم", style: boldStyle.copyWith(fontSize: 10), textDirection: TextDirection.rtl, textAlign: TextAlign.center))),
                  Container(
                      color: grey,
                      child: Center(
                          child: Text("المعرض",
  ...
  void printJournalDocument(
      m.BuildContext context,
      List<JournalDocumentDialyResponse> data,
      DateTime datefrom,
      DateTime dateto,
      int fromaccount,
      int toaccount,
      int fromkind,
      int tokind,
      GlAccountResponse fromglAccountResponse,
      GlAccountResponse toglAccountResponse,
      CostCenterResponse fromcost,
      CostCenterResponse tocost) async {
    final doc = Document();
    const PdfColor grey = PdfColors.grey400;
    final font = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
    final fontLight = await rootBundle.load("assets/fonts/Cairo-Light.ttf");
