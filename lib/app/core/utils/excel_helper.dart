...
class ExcelHelper {
  ...
  // static Future<Excel> movementSalesReportsExcel(List<InvoiceMovementReport> reports, BuildContext context) async {
  //   var excel = Excel.createExcel();
  ...
  // }
  //
  // static Future<Excel> statementsExcel(List<OrganizationSiteStatements> reports, BuildContext context) async {
  //   var excel = Excel.createExcel();
  ...
  // }
  //
  // static Future<Excel> productsExcel(List<Product> reports, BuildContext context) async {
  //   var excel = Excel.createExcel();
  ...
  // }
  //
  // static Future<Excel> galleryInvoicesExcel(List<InvoiceModel> reports, BuildContext context) async {
  //   var excel = Excel.createExcel();
  //   excel.updateCell(excel.sheets.values.first.sheetName, CellIndex.indexByColumnRow(columnIndex: 0, rowIndex: 0), "رقم الفاتورة");
